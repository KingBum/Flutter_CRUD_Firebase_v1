...
class _TeacherPageState extends State<Teacher> {
  ...
  Future<void> _createOrUpdate([DocumentSnapshot? documentSnapshot]) async {
    ...
    if (documentSnapshot != null) {
      action = 'update';
      _field1Controller.text = documentSnapshot['maGV'];
                  ...
                  onPressed: () async {
                    ...
                    if (maSV != null && ngaySinh != null || gioiTinh != null || queQuan != null) {
                      if (action == 'create') {
                        ...
                        await _Students.add({"maGV": maSV, "hoTen": ngaySinh, 'diaChi': gioiTinh, 'sdt': queQuan});
                      }
                      ...
                      if (action == 'update') {
                        ...
                        await _Students
                            ...
                            .update({"maGV": maSV, "hoTen": ngaySinh, 'diaChi': gioiTinh, 'sdt': queQuan});
                      }
