...
class _SubjectPageState extends State<Subject> {
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (maSV != null && ngaySinh != null || gioiTinh != null) {
                      if (action == 'create') {
                        // Persist a new product to Firestore
                        await _Students.add({"maMH": maSV, "tenMH": ngaySinh, 'Mota': gioiTinh});
                      }
                      ...
                      if (action == 'update') {
                        ...
                        await _Students
                            ...
                            .update({"maMH": maSV, "tenMH": ngaySinh, 'Mota': gioiTinh});
                      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Subjects Data'),
      ),
