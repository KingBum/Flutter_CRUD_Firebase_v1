...
class ClassRoom extends StatefulWidget {
  ...
  @override
  State<ClassRoom> createState() => _ClassRoomPageState();
}

class _ClassRoomPageState extends State<ClassRoom> {
                  ...
                  onPressed: () async {
                    ...
                    if (maSV != null && ngaySinh != null || gioiTinh != null || queQuan != null) {
                      if (action == 'create') {
                        ...
                        await _Students.add({"maLH": maSV, "tenLop": ngaySinh, 'slSV': gioiTinh, 'maGV': queQuan});
                      }
                      ...
                      if (action == 'update') {
                        ...
                        await _Students
                            ...
                            .update({"maLH": maSV, "tenLop": ngaySinh, 'slSV': gioiTinh, 'maGV': queQuan});
                      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ClassRooms Data'),
      ),
